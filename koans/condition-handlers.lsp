...
(define-test test-conditions-derive-from-types
  ...
  (true-or-false? t (typep (make-condition 'minimal-error-cond) 'minimal-error-cond))
  (true-or-false? t (typep (make-condition 'minimal-error-cond) 'error))
  (true-or-false? nil (typep (make-condition 'minimal-error-cond) 'warning))
  (true-or-false? t (typep (make-condition 'minimal-warning-cond) 'minimal-warning-cond))
  (true-or-false? nil (typep (make-condition 'minimal-warning-cond) 'error))
  (true-or-false? t (typep (make-condition 'minimal-warning-cond) 'warning)))
